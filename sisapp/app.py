...
def edit_student(student_id):
    ...
    if request.method == 'POST':
        ...
        if not all(student_data.values()):
            flash('All fields are required!', 'error')
            return render_template('register.html', form_data=student_data, student=student, is_edit=True)
    ...
    return render_template('register.html', form_data=student.to_dict(), student=student, is_edit=True)
